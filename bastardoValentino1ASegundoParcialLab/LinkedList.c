...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    if(this!=NULL && nodeIndex>=0&&nodeIndex<=ll_len(this))
    {
        ...
        if(auxNode!=NULL)
        {
            ...
            if(nodeIndex==0)
            {
             auxNode->pNextNode=getNode(this,0);
...
int ll_add(LinkedList* this, void* pElement)
{
  /*  int returnAux = -1;
    int tam=ll_len(this);
    Node* prevNode=getNode(this,tam-1);
    if(this!=NULL)
    {
        Node* auxNode=NULL;
        auxNode=(Node*) malloc(sizeof(Node));
...
/** \brief  recibe un linked list y lo filtra utilizando como criterio una pFunc, la cual retorna la direccion de memoria para ser añadida al nuevo linked list filtrado
 *
 * \param void*
 * \return LinkedList* ll_filter(LinkedList* this,       retorna un nuevo linked list, con los elementos que pasaron el criterio
 *
 */
LinkedList* ll_filter(LinkedList* this, int(*pFunc)(void*))
{
    ...
    if(this!=NULL)
    {
        ...
        void* aux=NULL;
        if(listaFiltrada!=NULL&&pFunc!=NULL)
        {
            int tam=ll_len(this);
            for(int i=0;i<tam;i++)
            {
...
/** \brief      itera los elementos de la lista y se los envia a pFunc el cual recibe el elemento y le asugna valores a sus campos.
 *
 * \param elemento void*
 * \return LinkedList* ll_map(LinkedList* this,     retorna un nuevo linked list en donde los elementos ahora tienen los valores cargados
 *
 */
